...
public class Extension extends ExtensionBase {
     ...
     */
    public int remainingBakeTime(int nMin) {
        return bakingTime() - nMin;
    }
     ...
     */
    public int calculatePrepTime(int nLayers) {
        return nLayers * 3;
    }
     ...
     */
    public int totalTimeSpent(int nLayers, int nMinutes) {
        return calculatePrepTime(nLayers) + nMinutes;
    }
